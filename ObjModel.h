...
//
//  Class Invariant:
//    <1> ObjStringParsing::isValidFilename(m_file_name)
...
//  Precondition(s):
//    <1> ObjStringParsing::isValidFilenameWithPath(filename)
//    <2> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: N/A
...
//  Precondition(s):
//    <1> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: N/A
...
//    <2> !Material::isMaterialActive()
//    <3> a_name != NULL
//    <4> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: A DisplayList for this ObjModel that uses Material
...
//  setFileName
//
//  Purpose: To change the file name of this ObjModel.
//  Parameter(s):
//    <1> filename: The new file name
//  Precondition(s):
//    <1> ObjStringParsing::isValidFilenameWithPath(filename)
//  Returns: N/A
//  Side Effect: This ObjModel is set to have file name
//               filename.  This does not change the file path.
//
...
//    <2> r_logstream: The stream to write loading errors to
//  Precondition(s):
//    <1> ObjStringParsing::isValidFilenameWithPath(library)
//    <2> ObjStringParsing::isValidFilenameWithPath(logfile)
//  Returns: N/A
